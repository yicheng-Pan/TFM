...
public class CourierOrderListAdapter extends RecyclerView.Adapter<CourierOrderListAdapter.ItemHolder> {
    ...
    public CourierOrderListAdapter(Context context, OnItemClickListner onItemClickListner) {
    ...
    public ItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ItemHolder(inflater.inflate(R.layout.item_order_courier, parent, false));
    }
