...
public class NotReceiveOrderListAdapter extends RecyclerView.Adapter<NotReceiveOrderListAdapter.ItemHolder> {
    ...
    public NotReceiveOrderListAdapter(Context context, OnItemClickListner onItemClickListner) {
    ...
    public ItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ItemHolder(inflater.inflate(R.layout.item_not_receive_order, parent, false));
    }
    ...
    class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private TextView goods_name, order_no, receive_address,tv_receive;
        ...
        public ItemHolder(@NonNull View itemView) {
            ...
            tv_receive.setOnClickListener(this::onClick);
        }
